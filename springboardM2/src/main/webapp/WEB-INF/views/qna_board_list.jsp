	...
	%>
		...
		<%
				...
				<tr align="center" valign="middle" bordercolor="#333333" onmouseover="this.style.backgroundColor='F8F8F8'" onmouseout="this.style.backgroundColor=''">
					<td height="23" style="font-family:Tahoma;font-size:10pt;"><%=number %></td>
					<td style="font-family:Tahoma;font-size:10pt;">
						...
						<% } else { %>
							▶
						<% } %>
						<a href="./BoardDetail.do?num=<%=bl.getBOARD_NUM() %>"><%=bl.getBOARD_SUBJECT() %></a>
						</div>
					</td>
		...
		<tr align=center height=20>
			<td colspan=7 style=font-family:Tahoma;font-size:10pt;>
				...
				[이전]&nbsp;
				<% } else { %>
				<a href="./list.do?page=<%=nowpage -1 %>">[이전]</a>&nbsp;
				<% } %>
				...
				[다음]
				<% } else { %>
					<a href="./list.do?page=<%=nowpage+1 %>">[다음]</a>
				<% } %>
			</td>
		</tr>
		<% } else { %>
		...
		<% } %>
		<tr align="right">
			<td colspan="5"><a href="./BoardWriteForm.do">[글쓰기]</a></td>
		</tr>
	</table>
</body>
</html>