...
public class BoardVO {
	...
	private String BOARD_STORED_FILE;
	...
	public String getBOARD_STORED_FILE() {
		return BOARD_STORED_FILE;
	}
	public void setBOARD_STORED_FILE(String bOARD_STORED_FILE) {
		BOARD_STORED_FILE = bOARD_STORED_FILE;
	}
