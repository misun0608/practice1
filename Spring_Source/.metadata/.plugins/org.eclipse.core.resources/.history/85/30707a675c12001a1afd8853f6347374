...
@Repository // annotation / @Controller와 동일한 형태로 사용되고 bean객체로 만들어진다
public class MemberDAO {
	...
	public int deleteMember(MemberVO memberVO) {
		...
		try {
			conn = JDBCUtil.getConnection(); // 연결객체 생성해서 할당
	...
	// 수정
	public int updateMember(MemberVO memberVO) {	// 선생님꺼랑 똑같음
		int result = 0;
