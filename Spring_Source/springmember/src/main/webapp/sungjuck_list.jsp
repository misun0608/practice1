...
<%
	...
	ArrayList<SungjuckVO> sungjuck_list = (ArrayList<SungjuckVO>)request.getAttribute("sungjuck_list");	// Object로 반환되기때문에 캐스트연산필요
%>
<html>
<head>
...
<body>
	...
	<center>
		<table border="1" width=300 align="center">
			...
			<td><a href="deletesungjuck.sj?id=<%=sungjuckVO.getId()%>">삭제</a></td>
